...
import { Bell, CheckCircle, AlertCircle, CreditCard, FileCheck, XCircle, RotateCcw } from 'lucide-react';
...
const notificationIcons: Record<string, React.ReactNode> = {
  ...
  lead_recalled: <RotateCcw className="text-secondary" size={24} />,
  lead_auto_rejected: <AlertCircle className="text-destructive" size={24} />,
};
...
const Notifications: React.FC = () => {
  ...
  const handleNotificationClick = (notification: Notification) => {
    ...
    const leadId = notification.data?.lead_id || notification.data?.leadId;
